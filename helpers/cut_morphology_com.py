...
def main():
    ...
    print(f"Center of the morphology z: {center_z=}")
    ...
    # Handle COM.dat file
    print("COM.dat file will be processed consistently with a new system ... ")
    ...
    with open('COM_updated.dat', 'w') as file:
        for index, line in enumerate(com_data):
            if index not in skip_ids:
                file.write(line)
    print("Updated COM.dat is called COM_updated.dat ... ")
